...
•	We, CODE DYNAMICS LLP ("We", "Us", "Our", “Company”), respect the privacy of everyone who visits this website, uses the desktop application and/or uses our mobile/tablet applications (the website, desktop application and the mobile application are collectively called, the “PAYSPOT APP”). The Company has created the PAYSPOT APP and licensed the use of the same, as part of its business operations. The services are rendered by the Company through the PAYSPOT APP.
